...
import static org.opensrp.etl.util.AllConstants.ADOLESCENT_TODAY;
...
public class AdolescentService implements RegisterService<AdolescentEntity> {
	...
	@Transactional
	private AdolescentEntity findByCaseIdAndToday(String relationalid, Date today) {
		return commonDatabaseRepository.findByCaseIdAndToday(ADOLESCENT_TODAY, relationalid, today, AdolescentEntity.class);
	}
}
