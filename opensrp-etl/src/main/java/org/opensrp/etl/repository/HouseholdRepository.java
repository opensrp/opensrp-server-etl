...
public class HouseholdRepository implements RegisterRepository<HouseholdEntity> {
    ...
    public void save(HouseholdEntity entity) {
        try {
            ...
            exceptionService.generatedEntityAndSave(entity.getCaseId(), e
                    .fillInStackTrace().toString(), "HouseHoldRepository",
                    entity.getINSTANCEID(), entity.get_id());
        }
    ...
    public boolean delete(HouseholdEntity householdEntity) {
        ...
        Query query = getSession().createQuery(
                "delete HouseholdEntity where id = :ID");
