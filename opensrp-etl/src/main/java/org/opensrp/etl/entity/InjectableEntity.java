...
public class InjectableEntity {
	...
	private String existing_Dose_No;
	
	private String Todays_Dose_No;
	
	private String Dose_No;
	
	private String Side_Effects;
	
	private String existing_Mem_NID;
	...
	public String getExisting_Dose_No() {
		return existing_Dose_No;
	}
	
	public void setexisting_Dose_No(String existing_Dose_No) {
		this.existing_Dose_No = existing_Dose_No;
	}
	
	public String getTodays_Dose_No() {
		return Todays_Dose_No;
	}
	
	public void setTodays_Dose_No(String todays_Dose_No) {
	...
	public String getExisting_Mem_NID() {
		return existing_Mem_NID;
	}
	
	public void setexisting_Mem_NID(String existing_Mem_NID) {
	...
	public void setinjectable_current_formStatus(String injectable_current_formStatus) {
