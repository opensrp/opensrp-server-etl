...
public class PSRFEntity {
	...
	private String Not_ELCO;
	
	private String Mother_Valid;
	
	private String Height;
	
	private String Mother_GoB_HHID;
	...
	public String getMother_GoB_HHID() {
		return Mother_GoB_HHID;
	}
	
	public void setMother_GoB_HHID(String mother_GoB_HHID) {
	...
	public String getNot_ELCO() {
		return Not_ELCO;
	}
	
	public void setNot_ELCO(String not_ELCO) {
		Not_ELCO = not_ELCO;
	}
	...
	public String toString() {
		return "PSRFEntity [id=" + id + ", Calc_EDD=" + Calc_EDD + ", Want_FP_Commodities=" + Want_FP_Commodities
		        + ", existing_Mem_Marital_Status=" + existing_Mem_Marital_Status + ", Child_Alive_Boy=" + Child_Alive_Boy
		        + ", existing_location=" + existing_location + ", Gestational_Age=" + Gestational_Age
		        + ", Current_Form_Status=" + Current_Form_Status + ", ELCO_Followup_Logic=" + ELCO_Followup_Logic
		        + ", Refer=" + Refer + ", existing_Final_Vill=" + existing_Final_Vill + ", clientVersion=" + clientVersion
		        + ", yn_dk_label=" + yn_dk_label + ", Confirm_Info=" + Confirm_Info + ", Visit_Status=" + Visit_Status
		        + ", Mother_BRID=" + Mother_BRID + ", Want_Change=" + Want_Change + ", Age_Youngest_Child="
		        + Age_Youngest_Child + ", Refer_FWV=" + Refer_FWV + ", Changed_FP_Method=" + Changed_FP_Method
		        + ", Calc_FP_Given_Date=" + Calc_FP_Given_Date + ", Total_Child_Alive=" + Total_Child_Alive
		        + ", Mother_Mauzapara=" + Mother_Mauzapara + ", Received_Time=" + Received_Time + ", existing_Mauzapara="
		        + existing_Mauzapara + ", start=" + start + ", Want_To_Use=" + Want_To_Use + ", Married_Life="
		        + Married_Life + ", Format_Injection_Date=" + Format_Injection_Date + ", existing_Couple_No="
		        + existing_Couple_No + ", Source_BC_Product=" + Source_BC_Product + ", Mother_Age=" + Mother_Age
		        + ", existing_Final_Dist=" + existing_Final_Dist + ", Mother_GoB_HHID=" + Mother_GoB_HHID + ", TT_Count="
		        + TT_Count + ", Mother_LMP=" + Mother_LMP + ", TT_Status=" + TT_Status + ", existing_ELCO=" + existing_ELCO
		        + ", Preg_Note=" + Preg_Note + ", ELCO=" + ELCO + ", version=" + version + ", TT_Dose=" + TT_Dose
		        + ", Prolong_Delivery=" + Prolong_Delivery + ", Permanent_M_Date=" + Permanent_M_Date
		        + ", existing_ELCO_NID=" + existing_ELCO_NID + ", Not_Preg_Note=" + Not_Preg_Note + ", end=" + end
		        + ", Provide_Pills_Condoms=" + Provide_Pills_Condoms + ", Gravida=" + Gravida + ", Pill_Given_No="
		        + Pill_Given_No + ", Last_FP_Method=" + Last_FP_Method + ", Format_Permanent_M_Date="
		        + Format_Permanent_M_Date + ", Type_Implant=" + Type_Implant + ", existing_Calc_Age_Confirm="
		        + existing_Calc_Age_Confirm + ", Next_Injection_Date=" + Next_Injection_Date + ", Format_Pill_Given_Date="
		        + Format_Pill_Given_Date + ", Injection_Date=" + Injection_Date + ", Marriage_Date=" + Marriage_Date
		        + ", existing_ELCO_Mobile_Number=" + existing_ELCO_Mobile_Number + ", Is_Eligible_Injectables="
		        + Is_Eligible_Injectables + ", Injetable=" + Injetable + ", Select_FP_Method=" + Select_FP_Method
		        + ", Birth_Control=" + Birth_Control + ", Wom_Met=" + Wom_Met + ", Cond_Given_No=" + Cond_Given_No
		        + ", Pill_Given_Date=" + Pill_Given_Date + ", Heavy_Blood_Flow=" + Heavy_Blood_Flow + ", Risky_Preg="
		        + Risky_Preg + ", Caesarean=" + Caesarean + ", Counselling=" + Counselling + ", Mother_Hus_Name="
		        + Mother_Hus_Name + ", serverVersion=" + serverVersion + ", Height=" + Height + ", existing_ELCO_BRID="
		        + existing_ELCO_BRID + ", Discuss_With_Fam=" + Discuss_With_Fam + ", PW=" + PW + ", Last_Pregnancy="
		        + Last_Pregnancy + ", today=" + today + ", existing_Final_Union=" + existing_Final_Union + ", Bleeding="
		        + Bleeding + ", Format_Next_Injection_Date=" + Format_Next_Injection_Date + ", existing_GoB_HHID="
		        + existing_GoB_HHID + ", Format_Cond_Given_Date=" + Format_Cond_Given_Date + ", Type_Oral_Pill="
		        + Type_Oral_Pill + ", Using_FP=" + Using_FP + ", Has_Changed=" + Has_Changed + ", ELCO_Date=" + ELCO_Date
		        + ", existing_Spouse_Name=" + existing_Spouse_Name + ", Eligible_Injectables=" + Eligible_Injectables
		        + ", Child_Alive_Girl=" + Child_Alive_Girl + ", Birth_Outcome=" + Birth_Outcome + ", Cond_Given_Date="
		        + Cond_Given_Date + ", Preg_Status=" + Preg_Status + ", Live_Birth=" + Live_Birth + ", existing_Mem_F_Name="
		        + existing_Mem_F_Name + ", Mother_NID=" + Mother_NID + ", Eligible=" + Eligible + ", LMP=" + LMP
		        + ", existing_HoH_F_Name=" + existing_HoH_F_Name + ", Mother_Valid=" + Mother_Valid + ", Pregnancy_Reg="
		        + Pregnancy_Reg + ", Dead_Child=" + Dead_Child + ", Mother_F_Name=" + Mother_F_Name + ", Not_ELCO="
		        + Not_ELCO + ", changes=" + changes + ", relationalid=" + relationalid + "]";
	}
