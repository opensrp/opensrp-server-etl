...
public class LocationTree {
	...
	public void addLocation(Location l) {
		if (!locationsHierarchy.hasNode(l.getId() + "")) {
			if (l.getParentLocation() == null) {
				locationsHierarchy.addNode(l.getId() + "", l.getName(), l, null);
			} else {
				locationsHierarchy.addNode(l.getId() + "", l.getName(), l, l.getParentLocation().getId() + "");
			}
		}
	}
