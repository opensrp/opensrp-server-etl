...
public class AclController {
	...
	public ModelAndView addPermission(@ModelAttribute("permission") @Valid Permission permission, BindingResult binding, ModelMap model) {
	...
	public ModelAndView getRole(Model model) {
		...
		return new ModelAndView("user/role", "command", role);
	}

	@RequestMapping(value = "/user/role", method = RequestMethod.POST)
	public ModelAndView addRole(@ModelAttribute("role") @Valid Role role, BindingResult binding, ModelMap model) {
		userService.manageRole(role);
		return new ModelAndView("redirect:/user/role");
	}
