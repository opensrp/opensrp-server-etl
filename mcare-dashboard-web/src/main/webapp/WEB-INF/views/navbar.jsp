...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="index.html"><img src="<c:url value="/resources/img/logo-total.png"/>"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Charts">
          ...
          <a class="nav-link" href="<c:url value="/household.html"/>">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Components">
         ...
         <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Components">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseRole" data-parent="#exampleAccordion">
            <i class="fa fa-fw fa-wrench"></i>
            <span class="nav-link-text">Role</span>
          </a>
          <ul class="sidenav-second-level collapse" id="collapseRole">
            <li>
              <a href="<c:url value="/role.html"/>">List</a>
            </li>
             <li>
              <a href="<c:url value="/role/add.html"/>">Add</a>
            </li>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Components">
          ...
          <ul class="sidenav-second-level collapse" id="collapseUser">
            <li>
              <a href="<c:url value="/user.html"/>">List</a>
            </li>
             <li>
