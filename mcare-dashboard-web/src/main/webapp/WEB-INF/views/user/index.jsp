		...
		<div class="row">
			<div class="col-md-12">
				<c:forEach var="user" items="${users}" varStatus="loop">
                   ...
                   <a href="<c:url value="/user/${user.id}/edit.html"/>">${user.getFullName()}</a> | ${user.getUsername()} | ${user.getEmail()}  |  <a href="<c:url value="/user/${user.id}/password.html"/>">Pasword Reset</a>  <br />
