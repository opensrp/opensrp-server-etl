...
<c:url var="saveUrl" value="child.html" />

<%
	List<ChildEntity> childs = (List<ChildEntity>) session
		...
		<div class="container-fluid">
			...
			<div class="card mb-3">
				<div class="card-header">
					<i class="fa fa-table"></i> Child Search
				</div>
				<div class="card-body">
					<form id="search-form">
						<div class="row">
										...
										<tbody>
											<%
												for (ChildEntity child : childs) {
													pageContext.setAttribute("id", child.getId());
											%>
											<tr class="even">
									...
									<div class="dataTables_paginate paging_simple_numbers"
										...
										<ul class="pagination">
											...
											<li class="paginate_button page-item disabled"><a
												...
												href="child.html?offSet=<%=i%><%=paginationLink%>"><%=i + ""%></a></li>
											<%
												}
													} else {
											%>
											...
											<li class="paginate_button page-item next"
												...
												class="page-link"
												href="child.html?offSet=<%=disabledLINK + 1%><%=paginationLink%>">Next</a>
											</li>
											<li class="paginate_button page-item next"
												id="dataTable_next"><a data-dt-idx="7" tabindex="0"
												class="page-link"
												href="child.html?offSet=<%=size%><%=paginationLink%>">End</a>
											</li>
											<%
												}
											%>
