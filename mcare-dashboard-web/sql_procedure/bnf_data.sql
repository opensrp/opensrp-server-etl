CREATE OR REPLACE FUNCTION bnf_data(filterArray text[])
RETURNS TABLE(
...
BEGIN
  ...
  CREATE TEMPORARY TABLE IF NOT EXISTS temp_table (
   ...
   END LOOP;
    ...
    where visit_code like \'BirthNotificationPregnancyStatusFollowUp\' '
    || filterString
   ...
   (select date_part(\'month\', date(a.start_date)),count(date_part(\'month\', date(a.start_date)))
     ...
     || filterString
     || E' and visit_code = \'BirthNotificationPregnancyStatusFollowUp\'
